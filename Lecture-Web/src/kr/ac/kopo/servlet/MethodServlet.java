...
public class MethodServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("	<body>");
		out.println("=========================================<br>");
		out.println("%nbsp;%nbsp;%nbsp;%nbsp;요 청 결 과<br>");
		out.println("=========================================<br>");
		...
		System.out.println("id : " + id); System.out.println("method : " + method);
		System.out.println("url : " + url.toString()); System.out.println("uri : " +
		uri);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title> 호출방식 - POST</title>");
		out.println("</head>");
		out.println("<body>");
		out.println("=====================================<br>");
